...
save_dir = './adapter_maps'
create_directory(save_dir)
chip_adapter = os.listdir('./ChIP_seq_finetuned_adapter')
...
for _, item in df.iterrows():
    ...
    ## main task adapter 
    adapter_collect[study + '_' + htselex_key] = os.path.join(study + '_finetuned_adapter', htselex_key)
    ...
    for adapter in chip_adapter:
        ...
        adapter_collect[adapter] = os.path.join('./ChIP_seq_finetuned_adapter', adapter)
